...
from pydra_server.cluster.module.master.amf_interface import AMFInterfaceModule as AMFInterfaceModule_import
...
AMFInterfaceModule = AMFInterfaceModule_import
